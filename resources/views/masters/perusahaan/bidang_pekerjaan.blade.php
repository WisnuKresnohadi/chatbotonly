...
@section('content')
    <div class="row">
        <div class="col-md-8 col-12">
            <h4 class="fw-bold"><span class="text-muted fw-light">Master Data /</span> Master Bidang Pekerjaan /
                {{ $nama_perusahaan }}</h4>
        </div>
    </div>
    <div class="mt-2 row">
    ...
    <!-- Modal -->
    @include('masters.perusahaan.modal')
@endsection
    ...
    <script>
        ...
        function perusahaanList() {
            var table = $('#table-master-perusahaan').DataTable({
                ajax: `{{ route('perusahaan.showDetailBidangPekerjaanPerusahaan', $id) }}`,
                serverSide: false,
                processing: true,
                deferRender: true,
                type: 'GET',
        ...
        function edit(e) {
            ...
            let action = `{{ route('perusahaan.update', ['id' => ':id']) }}`.replace(':id', id);
            let url = `{{ route('perusahaan.edit', ['id' => ':id']) }}`.replace(':id', id);
        ...
        function afterAction(response) {
            ...
            $('#table-master-perusahaan').DataTable().ajax.reload();
        }
